...
const PermohonanPending = (props) => {
    ...
    const load = () => {
        setLoading(true);
        _Axios.post(`admin/skb/submission/lists-by-status`,{status : 1})
            .then(res => {
    ...
    return (
        <Aux>
            <Row>
                <Col>
                    <Card title='Permohonan KJSB Pending' isOption>
                        <List
                            loading={loading}
...
export default PermohonanPending;